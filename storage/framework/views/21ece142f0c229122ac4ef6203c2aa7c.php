    ...
    <div class="commande">
        ...
        <div class="info">
           ...
           <tr><td><p> Adress : </p></td><td><input type="text" name="prix" value="<?php echo e($resultat->adress); ?>" class="form-control" readonly></td></tr>
            ...
            <form id="cartForm" action="<?php echo e(route('acceuil.viewart')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('acceuil.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/acceuil/rchparadress.blade.php ENDPATH**/ ?>