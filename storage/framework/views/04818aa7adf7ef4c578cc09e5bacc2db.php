...
<div class="conteneur-commandes">
    <?php $__currentLoopData = $commandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcommande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="commande">
        <?php if($pcommande->product): ?>
        <img src="<?php echo e(asset('images/' . $pcommande->product->image)); ?>" alt="Image du produit" class="img-fluid rounded">
    <?php else: ?>
    ...
    <?php endif; ?>
        ...
        <div class="info">
           <table>
           <tr><td> <h3> Nom du Produit : </h3></td><td><input type="text" name="nomproduit" value="<?php echo e($pcommande->nomproduit); ?>" class="form-control" readonly></td></tr>
           <tr><td><p> Prix du Produit : </p></td><td><input type="text" name="prix" value="<?php echo e($pcommande->prix); ?>" class="form-control" readonly></td></tr>
            ...
            <br>
            <tr><td> <p>   Etat : </p></td><td><input type="text" name="etat" value="<?php echo e($pcommande->etat); ?>" class="form-control2" readonly style="color:
                ...
                <?php elseif($pcommande->etat == 'livrer'): ?>
                    green
                <?php elseif($pcommande->etat == 'Accepter'): ?>
                    green
                <?php elseif($pcommande->etat == 'Annuler'): ?>
                    red
                <?php else: ?>
                brown
            ...
            <br>
            <?php if($pcommande->etat == 'en attente'): ?>
            <a href="<?php echo e(route('artisan.accepterclient', ['id' => $pcommande->id])); ?>">
            ...
            <?php endif; ?>
            <?php if($pcommande->etat == 'en attente'): ?>
            <a href="<?php echo e(route('artisan.annulerclient', ['id' => $pcommande->id])); ?>">
            ...
            <?php if($pcommande->etat == 'Accepter'): ?>
            <a href="<?php echo e(route('artisan.choixlivreur', ['id' => $pcommande->id])); ?>">
...
<?php echo $__env->make('artisan.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/artisan/gestioncom.blade.php ENDPATH**/ ?>