...
<section class="products" style="margin-top: 2cm">
    <h1 class="title"> Les <span>propos de livraison </span> <a href="#"> >></a> </h1>
<div class="conteneur-commandes">
    ...
    <?php endif; ?>
        ...
        <div class="info">
            <form id="cartForm" action="<?php echo e(route('livreur.accepte')); ?>" method="POST" onsubmit="return confirm('Voulez-vous accepter cette commande ?')">
                <?php echo csrf_field(); ?>
          ...
          <tr><td>  <p>    Prix    :</p></td>  <td> <input type="text" name="prix" value="<?php echo e($commande->prix); ?>" class="form-control" readonly></td></tr>
           ...
           <tr><td>   <p> tele Client : </p></td> <td><input type="text" name="tele_client" value="<?php echo e($commande->tele_client); ?>" class="form-control" readonly></td></tr>
            ...
            <tr><td>  <p> Adress Artisan :</p></td><td> <input type="text" name="adress_art" value="<?php echo e($commande->adress_art); ?>" class="form-control" readonly></td></tr>
                <tr><td>   <p> tele Artisan : </p></td> <td><input type="text" name="tele_art" value="<?php echo e($commande->tele_art); ?>" class="form-control" readonly></td></tr></table>
            ...
            <a href="<?php echo e(route('livreur.destroy', ['id' => $commande->id , 'id_commande' => $commande->id_commande])); ?>">
                <button type="submit" class="supprimer-btn action-btn " onclick="confirmerSuppression()">
                    refuser
                </button>
            </a>
            <script>
...
<?php echo $__env->make('livreur.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/livreur/accepterefuser.blade.php ENDPATH**/ ?>