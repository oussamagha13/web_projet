<?php $__env->startSection('content'); ?>
    ...
    <div class="conteneur-commandes">
        <?php $__currentLoopData = $livreur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcommande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="commande">
                <img src="<?php echo e(asset('image/74181848-icône-livreur-plat.jpg')); ?>" alt="Image du livreur" class="img-fluid rounded">
                <div class="info">
                    <table>
                        <tr>
                            <td><h3>Nom :</h3></td>
                            <td><input type="text" name="nomproduit" value="<?php echo e($pcommande->name); ?>" class="form-control" readonly></td>
                        </tr>
                        <tr>
                            <td><p>Adresse :</p></td>
                            <td><input type="text" name="adresse" value="<?php echo e($pcommande->adress); ?>" class="form-control" readonly></td>
                        </tr>
                        <tr>
                            <td><p>Téléphone :</p></td><br>
                            <td><input type="text" name="telephone" value="<?php echo e($pcommande->tele); ?>" class="form-control" readonly></td>
                        </tr>
...
<?php endif; ?>
                    ...
                    <a href="#"  onclick="showEvaluationForm('<?php echo e($pcommande->name); ?>', '<?php echo e($pcommande->prix); ?>', '<?php echo e($pcommande->id); ?>', '<?php echo e($pcommande->id_art); ?>')">
...
<?php echo $__env->make('client.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/client/affichelivreur.blade.php ENDPATH**/ ?>