...
<div class="centered-container">
    <div class="card">
        ...
        <div class="form-group">
            ...
            <?php if($user->dis == 'disponible'): ?>
                green
            <?php elseif($user->dis == 'non disponible'): ?>
                red
            <?php else: ?>
            brown
            <?php endif; ?>;"><?php echo e($user->dis); ?></p>
        </div>
...
<div id="editProfileModal">
    <div class="modal-card">
        ...
        <form method="post" action="<?php echo e(route('profileliv.update')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('livreur.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/livreur/profile.blade.php ENDPATH**/ ?>