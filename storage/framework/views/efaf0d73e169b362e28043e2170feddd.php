    ...
    <div class="commande">
        ...
        <div class="info">
           ...
           <tr><td><p> sous type : </p></td><td><input type="text" name="prix" value="<?php echo e($pcommande->soustype); ?>" class="form-control" readonly></td></tr>
            ...
            <br>
            <a href="#" class="btn btn-primary" onclick="showCartForm('<?php echo e($pcommande->name); ?>', '<?php echo e($pcommande->prix); ?>', '<?php echo e($pcommande->id); ?>', '<?php echo e($pcommande->id_art); ?>')">Ajouter au Panier</a>
...
<?php echo $__env->make('client.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/client/viewprod.blade.php ENDPATH**/ ?>