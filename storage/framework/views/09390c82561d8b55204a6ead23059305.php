...
<div class="container">
    <form action="<?php echo e(route('artisan.store')); ?>" method="POST" enctype="multipart/form-data" class="custom-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('artisan.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TOSHIBA\OneDrive\Bureau\laravel\shop\resources\views/artisan/create.blade.php ENDPATH**/ ?>