...
<header class="header">
    ...
    <nav class="navbar">
        <a href="{{ route('artisan.index') }}">Acceuil</a>
        <a href="{{ route('artisan.gestioncom') }}">Gestion des Commandes</a>
        <a href="{{ route('artisan.index') }}">Gestion des Produits</a>
    ...
    <div class="icons">
        ...
        <a href="{{ route('artisan.profile') }}" style="text-decoration: none; color: white; margin-left: 8px;">
...
<nav class="nv">
    <a href="{{ route('artisan.index', 1) }}" class="page-link @if(request()->routeIs('artisan.index')) selected @endif">salé/sucre</a>
    <a href="{{ route('artisan.sucre', 2) }}" class="page-link @if(request()->routeIs('artisan.sucre')) selected @endif">sucré</a>
    <a href="{{ route('artisan.sale', 3) }}" class="page-link @if(request()->routeIs('artisan.sale')) selected @endif">salé</a>
</nav>
<script>
