...
<div class="centered-container">
    <div class="card">
        ...
        <div class="form-group">
            ...
            <p id="tele">{{ $user->heure_douverture }}</p>
        </div>

        <div class="form-group">
            <label for="tele">Type de Produit :</label>
            <p id="tele">{{ $user->type_produit }}</p>
        </div>

        <div class="form-group">
            <label for="tele">Description :</label>
            <p id="tele">{{ $user->description }}</p>
        </div>
...
<div id="editProfileModal">
    <div class="modal-card">
        ...
        <form method="post" action="{{ route('profileart.update') }}">
            @csrf
            @method('put')
            ...
            <div class="form-group">
                <label for="tele">Heure d'Ouverture:</label>
                <input type="text" id="heure_douverture" name="heure_douverture" value="{{ $user->heure_douverture }}">
            </div>
