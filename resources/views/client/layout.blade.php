...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="{{ route('client.gestiondecommande') }}">Gestion de Commande</a>
        <a href="#">About</a>
...
<form id="formRecherche" class="hidden" action="{{ route('client.recherche') }}" method="GET">
    ...
    <button type="submit" class="btn btn-primary">Rechercher</button>
        ...
        <a href="{{ route('client.panier') }}"><div id="cart-btn" class="fas fa-shopping-cart" ></div></a>
...
<nav class="nv">
    <a href="{{ route('client.index', 1) }}" class="page-link @if(request()->routeIs('client.index')) selected @endif">salé/sucre</a>
    <a href="{{ route('client.sucre', 2) }}" class="page-link @if(request()->routeIs('client.sucre')) selected @endif">sucré</a>
    <a href="{{ route('client.sale', 3) }}" class="page-link @if(request()->routeIs('client.sale')) selected @endif">salé</a>
</nav>
<script>
