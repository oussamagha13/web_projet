...
<header class="header">
    ...
    <nav class="navbar">
        <a href="{{ route('acceuil.index') }}">Acceuil</a>
...
<form id="formRecherche" class="hidden" action="{{ route('acceuil.recherche') }}" method="GET">
...
<nav class="nv">
    <a href="{{ route('acceuil.index', 1) }}" class="page-link @if(request()->routeIs('acceuil.index')) selected @endif">salé/sucre</a>
    <a href="{{ route('acceuil.sucre', 2) }}" class="page-link @if(request()->routeIs('acceuil.sucre')) selected @endif">sucré</a>
    <a href="{{ route('acceuil.sale', 3) }}" class="page-link @if(request()->routeIs('acceuil.sale')) selected @endif">salé</a>
</nav>
<script>
